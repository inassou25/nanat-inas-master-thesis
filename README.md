...
```
01_data_preparation/    → Nettoyage de la base de données + Split temporel strict (70/15/15)
...
|---------|-------------|-------------|
| **M1** | Features structurées seules | LR, XGBoost |
...
La base de connaissances contient 41 passages issus de 6 articles académiques sur la satisfaction e-commerce (Masyhuri 2022, Al-Ayed 2022, Nguyen & Chanut 2018, De Caigny et al. 2020, Tirunillai & Tellis 2014, Archak et al. 2011).
